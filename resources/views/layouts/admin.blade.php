	...
	<body class="{{ ($isRtl ?? false) ? 'font-arabic' : 'font-sans' }} antialiased" x-data="{ 
		...
		<div class="min-h-screen bg-gray-100 dark:bg-gray-900">
			...
			<div class="flex">
				<!-- Sidebar -->
				<aside
					class="fixed inset-y-0 {{ ($isRtl ?? false) ? 'right-0 border-l' : 'left-0 border-r' }} z-30 w-72 transform transition-all duration-300 md:transform-none md:static bg-gradient-to-br from-indigo-900 via-purple-900 to-indigo-800 dark:from-indigo-950 dark:via-purple-950 dark:to-indigo-900 border-indigo-700/50 dark:border-indigo-800/50 overflow-y-auto shadow-2xl"
					:class="{ 
				...
				>
					<div class="flex h-full flex-col justify-between p-4">
						<div>
							...
							<nav class="space-y-2 pt-6">
								...
								<div x-data="{ open: {{ request()->routeIs('products.*') || request()->routeIs('categories.*') || request()->routeIs('suppliers.*') ? 'true' : 'false' }} }">
									...
									<div x-show="open && !sidebarCollapsed" x-transition class="{{ ($isRtl ?? false) ? 'mr-4 pr-4 border-r-2' : 'ml-4 pl-4 border-l-2' }} mt-1 space-y-1 border-indigo-700/50 dark:border-indigo-800/50">
										<a href="{{ route('products.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-all duration-200 {{ request()->routeIs('products.index') ? 'bg-blue-600/80 text-white' : 'text-indigo-200 hover:text-white hover:bg-indigo-800/60 dark:hover:bg-indigo-900/60' }}" title="{{ __('Products') }}">
										...
										<a href="{{ route('products.create') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-all duration-200 {{ request()->routeIs('products.create') ? 'bg-blue-600/80 text-white' : 'text-indigo-200 hover:text-white hover:bg-indigo-800/60 dark:hover:bg-indigo-900/60' }}" title="{{ __('Add Product') }}">
										...
										<a href="{{ route('categories.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-all duration-200 {{ request()->routeIs('categories.*') ? 'bg-blue-600/80 text-white' : 'text-indigo-200 hover:text-white hover:bg-indigo-800/60 dark:hover:bg-indigo-900/60' }}" title="{{ __('Categories') }}">
										...
										<a href="{{ route('suppliers.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-all duration-200 {{ request()->routeIs('suppliers.*') ? 'bg-blue-600/80 text-white' : 'text-indigo-200 hover:text-white hover:bg-indigo-800/60 dark:hover:bg-indigo-900/60' }}" title="{{ __('Suppliers') }}">
								...
								<div x-data="{ open: {{ request()->routeIs('sourcings.*') || request()->routeIs('shipping-methods.*') ? 'true' : 'false' }} }">
									...
									<div x-show="open && !sidebarCollapsed" x-transition class="{{ ($isRtl ?? false) ? 'mr-4 pr-4 border-r-2' : 'ml-4 pl-4 border-l-2' }} mt-1 space-y-1 border-indigo-700/50 dark:border-indigo-800/50">
										...
										<a href="{{ route('sourcings.create') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-all duration-200 {{ request()->routeIs('sourcings.create') ? 'bg-blue-600/80 text-white' : 'text-indigo-200 hover:text-white hover:bg-indigo-800/60 dark:hover:bg-indigo-900/60' }}" title="{{ __('Sourcing Creation') }}">
											<svg class="h-4 w-4 shrink-0" viewBox="0 0 24 24" fill="currentColor"><path d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z"/></svg>
											<span class="whitespace-nowrap">{{ __('Sourcing Creation') }}</span>
										</a>
										<a href="{{ route('shipping-methods.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-all duration-200 {{ request()->routeIs('shipping-methods.*') ? 'bg-blue-600/80 text-white' : 'text-indigo-200 hover:text-white hover:bg-indigo-800/60 dark:hover:bg-indigo-900/60' }}" title="{{ __('Shipping Methods') }}">
											<svg class="h-4 w-4 shrink-0" viewBox="0 0 24 24" fill="currentColor"><path d="M20 8h-3V4H3c-1.1 0-2 .9-2 2v11h2c0 1.66 1.34 3 3 3s3-1.34 3-3h6c0 1.66 1.34 3 3 3s3-1.34 3-3h2v-5l-3-4zM6 18.5c-.83 0-1.5-.67-1.5-1.5s.67-1.5 1.5-1.5 1.5.67 1.5 1.5-.67 1.5-1.5 1.5zm13.5-9l1.96 2.5H17V9.5h2.5zm-1.5 9c-.83 0-1.5-.67-1.5-1.5s.67-1.5 1.5-1.5 1.5.67 1.5 1.5-.67 1.5-1.5 1.5z"/></svg>
											<span class="whitespace-nowrap">{{ __('Shipping Methods') }}</span>
										</a>
									</div>
								</div>
								<a href="{{ route('invoices.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-all duration-200 {{ request()->routeIs('invoices.*') ? 'bg-blue-600 text-white shadow-lg shadow-blue-600/50' : 'text-indigo-100 hover:text-white hover:bg-indigo-800/60 dark:hover:bg-indigo-900/60' }}" :class="{ 'justify-center': sidebarCollapsed }" title="{{ __('Invoices') }}">
								...
								<div x-data="{ open: {{ request()->routeIs('expense-categories.*') || request()->routeIs('balances.*') || request()->routeIs('expenses.*') ? 'true' : 'false' }} }">
									...
									<div x-show="open && !sidebarCollapsed" x-transition class="{{ ($isRtl ?? false) ? 'mr-4 pr-4 border-r-2' : 'ml-4 pl-4 border-l-2' }} mt-1 space-y-1 border-indigo-700/50 dark:border-indigo-800/50">
										<a href="{{ route('expense-categories.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-all duration-200 {{ request()->routeIs('expense-categories.*') ? 'bg-blue-600/80 text-white' : 'text-indigo-200 hover:text-white hover:bg-indigo-800/60 dark:hover:bg-indigo-900/60' }}" title="{{ __('Expense Categories') }}">
											<svg class="h-4 w-4 shrink-0" viewBox="0 0 24 24" fill="currentColor"><path d="M10 4H4c-1.11 0-2 .89-2 2v12c0 1.11.89 2 2 2h16c1.11 0 2-.89 2-2V8c0-1.11-.89-2-2-2h-8l-2-2z"/></svg>
											<span class="whitespace-nowrap">{{ __('Expense Categories') }}</span>
										</a>
										<a href="{{ route('balances.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-all duration-200 {{ request()->routeIs('balances.*') ? 'bg-blue-600/80 text-white' : 'text-indigo-200 hover:text-white hover:bg-indigo-800/60 dark:hover:bg-indigo-900/60' }}" title="{{ __('Balances') }}">
										...
										<a href="{{ route('expenses.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-all duration-200 {{ request()->routeIs('expenses.*') ? 'bg-blue-600/80 text-white' : 'text-indigo-200 hover:text-white hover:bg-indigo-800/60 dark:hover:bg-indigo-900/60' }}" title="{{ __('Expenses') }}">
								...
								<div x-data="{ open: {{ request()->routeIs('ads-campaigns.*') || request()->routeIs('ads-platforms.*') ? 'true' : 'false' }} }">
									...
									<div x-show="open && !sidebarCollapsed" x-transition class="{{ ($isRtl ?? false) ? 'mr-4 pr-4 border-r-2' : 'ml-4 pl-4 border-l-2' }} mt-1 space-y-1 border-indigo-700/50 dark:border-indigo-800/50">
										<a href="{{ route('ads-campaigns.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-all duration-200 {{ request()->routeIs('ads-campaigns.*') ? 'bg-blue-600/80 text-white' : 'text-indigo-200 hover:text-white hover:bg-indigo-800/60 dark:hover:bg-indigo-900/60' }}" title="{{ __('Ads Campaigns') }}">
										...
										<a href="{{ route('ads-platforms.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-all duration-200 {{ request()->routeIs('ads-platforms.*') ? 'bg-blue-600/80 text-white' : 'text-indigo-200 hover:text-white hover:bg-indigo-800/60 dark:hover:bg-indigo-900/60' }}" title="{{ __('Manage Platforms') }}">
						...
						<div class="pt-4 mt-6 border-t border-indigo-700/50 dark:border-indigo-800/50 space-y-2">
							<a href="{{ route('profile.edit') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium text-indigo-100 hover:text-white hover:bg-indigo-800/60 dark:hover:bg-indigo-900/60 transition-all duration-200" :class="{ 'justify-center': sidebarCollapsed }" title="{{ __('Profile') }}">
