	...
	<div class="py-6">
		<div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
			<div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg p-6">
				<form method="POST" action="{{ route('testing-products.update', $testingProduct) }}" class="space-y-6">
					@csrf
					@method('PUT')
					...
					<div>
						...
						<input 
							...
							name="product_name" 
							id="product_name" 
							value="{{ old('product_name', $testingProduct->product_name) }}"
					...
					<div>
						...
						<input 
							...
							name="product_link" 
							id="product_link" 
							value="{{ old('product_link', $testingProduct->product_link) }}"
					...
					<div>
						...
						<input 
							...
							value="{{ old('facebook_library_link', $testingProduct->facebook_library_link) }}"
							...
							@foreach($countries as $country)
								<div class="flex items-center">
									<input 
										...
										value="{{ $country->id }}"
										{{ in_array($country->id, old('country_ids', $testingProduct->country_ids ?? [])) ? 'checked' : '' }}
					...
					<div>
						...
						<input 
							...
							name="video_url" 
							id="video_url" 
							value="{{ old('video_url', $testingProduct->video_url) }}"
