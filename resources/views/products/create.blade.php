			...
			<div class="bg-white dark:bg-gray-800 shadow-sm rounded-xl p-4 sm:p-6">
				<form method="POST" action="{{ route('products.store') }}" enctype="multipart/form-data" class="space-y-5">
					...
					<div>
						...
						<input type="number" name="low_stock_threshold" min="0" value="5" class="w-full py-2.5 px-3 rounded-lg border border-gray-200 dark:border-gray-600 bg-gray-50 dark:bg-gray-700/50 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
					</div>
