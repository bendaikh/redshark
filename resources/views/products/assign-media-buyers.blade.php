<x-admin-layout>
	<x-slot name="header">
		<div class="flex items-center gap-4">
			<a href="{{ route('products.index') }}" class="text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-gray-100">
	...
	<div class="py-6">
		<div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
			<div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg">
				...
				<form method="POST" action="{{ route('products.update-media-buyers', $product) }}" class="p-6 space-y-6">
					@csrf
					@method('PUT')
						...
						@else
							<div class="space-y-3 max-h-96 overflow-y-auto border border-gray-200 dark:border-gray-700 rounded-md p-4">
								@foreach($mediaBuyers as $mediaBuyer)
									<div class="p-3 rounded-md border border-gray-200 dark:border-gray-600 {{ in_array($mediaBuyer->id, $assignedMediaBuyers) ? 'bg-indigo-50 dark:bg-indigo-900/20' : 'bg-gray-50 dark:bg-gray-700' }}">
										<div class="flex items-start gap-3">
											<input 
												...
												class="mt-1 rounded border-gray-300 dark:border-gray-700 text-indigo-600 shadow-sm focus:ring-indigo-500 dark:focus:ring-indigo-600 dark:bg-gray-900"
											...
											<div class="flex-1">
												...
												<div id="cost_input_{{ $mediaBuyer->id }}" class="{{ in_array($mediaBuyer->id, $assignedMediaBuyers) ? '' : 'hidden' }}">
													...
													<input 
														...
														min="0"
														placeholder="0.00"
														class="w-full rounded border-gray-300 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-100 text-sm"
													>
												</div>
											</div>
										</div>
