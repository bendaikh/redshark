	...
	<body class="font-sans antialiased" x-data="{ 
		...
		<div class="min-h-screen bg-surface-warm dark:bg-gray-900">
			...
			<div class="flex">
				<!-- Sidebar -->
				<aside
					class="fixed inset-y-0 left-0 z-30 w-72 transform transition-all duration-300 md:transform-none md:static bg-sidebar border-r border-white/10 overflow-y-auto shadow-2xl"
					:class="{ 
				...
				>
					<div class="flex h-full flex-col justify-between p-4">
						<div>
							<div class="hidden md:flex items-center justify-center px-2 pb-6 border-b border-white/10" :class="{ 'justify-start': !sidebarCollapsed }">
								<a href="{{ route('media-buyer.dashboard') }}" class="inline-flex items-center gap-2 group" :class="{ 'justify-center': sidebarCollapsed }">
									...
									<span class="text-lg font-bold text-white whitespace-nowrap group-hover:text-primary-300 transition-colors" x-show="!sidebarCollapsed" x-transition>Media Buyer</span>
								</a>
							</div>

							<nav class="space-y-2 pt-6">
								<!-- Dashboard Section -->
								<a href="{{ route('media-buyer.dashboard') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-all duration-200 {{ request()->routeIs('media-buyer.dashboard') ? 'bg-primary-500 text-white shadow-lg shadow-primary-500/50' : 'text-slate-400 hover:text-white hover:bg-white/10' }}" :class="{ 'justify-center': sidebarCollapsed }" title="Dashboard">
								...
								<!-- Testing Section -->
								<a href="{{ route('media-buyer.testing') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-all duration-200 {{ request()->routeIs('media-buyer.testing') ? 'bg-primary-500 text-white shadow-lg shadow-primary-500/50' : 'text-slate-400 hover:text-white hover:bg-white/10' }}" :class="{ 'justify-center': sidebarCollapsed }" title="Testing">
								...
								<!-- Products Section -->
								<a href="{{ route('media-buyer.products') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-all duration-200 {{ request()->routeIs('media-buyer.products') ? 'bg-primary-500 text-white shadow-lg shadow-primary-500/50' : 'text-slate-400 hover:text-white hover:bg-white/10' }}" :class="{ 'justify-center': sidebarCollapsed }" title="Products">
								...
								<!-- Expenses Section -->
								<a href="{{ route('media-buyer.expenses') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-all duration-200 {{ request()->routeIs('media-buyer.expenses*') ? 'bg-primary-500 text-white shadow-lg shadow-primary-500/50' : 'text-slate-400 hover:text-white hover:bg-white/10' }}" :class="{ 'justify-center': sidebarCollapsed }" title="Expenses">
								...
								<!-- Campaigns Section -->
								<a href="{{ route('media-buyer.campaigns') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-all duration-200 {{ request()->routeIs('media-buyer.campaigns*') ? 'bg-primary-500 text-white shadow-lg shadow-primary-500/50' : 'text-slate-400 hover:text-white hover:bg-white/10' }}" :class="{ 'justify-center': sidebarCollapsed }" title="Ad Campaigns">
						...
						<div class="pt-4 mt-6 border-t border-white/10 space-y-2">
							<a href="{{ route('profile.edit') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium text-slate-400 hover:text-white hover:bg-white/10 transition-all duration-200" :class="{ 'justify-center': sidebarCollapsed }" title="Profile">
